...
*
*******************************************************/
//Uncomment this line if you use and standard IO function
//#include <cstdio>
#include <iostream>
#include <fstream>
#include <cmath>
...
#define SA_DEBUG    1		// redirect cin to input file for the problem and cout to output file for the problem

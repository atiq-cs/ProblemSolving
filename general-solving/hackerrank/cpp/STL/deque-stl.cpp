...
* Problem URL : https://www.hackerrank.com/challenges/deque-stl
* Date        : Jan 3 2016
* Complexity  : O(N) as argued by geekforgeeks
* Author      : Atiq Rahman
* Status      : Accepted
* Desc        : Idea from: http://www.geeksforgeeks.org/maximum-of-all-subarrays-of-size-k/ 
...
*
* meta        : tag-data-structure, tag-deque
***************************************************************************/

...
* Author : Atiq Rahman
* Date   : 2015-06-23
* Notes  : This algorithm is tested by solving
*    https://uva.onlinejudge.org/external/1/p146.pdf
*   For reference, please have a look at 'online-problem-solving/uva-online-judge/146_ID_Codes.cpp'
*   If you are looking for C Lang implementation please have a look here:
*    'online-problem-solving/uva-online-judge/146_ID_Codes_nasty_C.cpp'
* Comp   : n lg(n), due to sorting
***************************************************************************************************/
#include <iostream>
#include <algorithm>
#include <string>

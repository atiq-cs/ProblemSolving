/***************************************************************************
* Problem Name: Adjustment Office
* Problem URL : http://codeforces.com/gym/100851/attachments/download/3961/\
20152016-acmicpc-northeastern-european-regional-contest-neerc-15-en.pdf
* Date        : Jan 22, 2016
* Complexity  : O() Time
* Author      : Atiq Rahman
* Status      : Accepted (108ms)
* Occasion    : 2015-2016 ACM-ICPC Northeastern European Regional Contest
* Notes       : 
*               fill in ...
*               
* meta        : tag-acm-icpc
